...
/**
 * 
 * Represents a point on a tile array for determining path lengths between
 * points
 * 
 * @author colinauyeung
 *
...
public class Node {
	...
	/**
	 * Given a parent node,
	 * if this parent would give this node a lower G cost, then make it this node's
	 * parent
	 * 
	...
	public void update(Node potentialParent) {
		// Calculate the G cost of this node if potentialParent becomes this node's
		// parent
	...
	/**
	 * Returns if the node is moveable.
	 * 
	 * @return If the node is moveable.
	 */
