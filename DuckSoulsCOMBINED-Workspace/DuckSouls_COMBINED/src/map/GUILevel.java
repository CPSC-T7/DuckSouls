		...
		scene.setOnKeyPressed(key -> {
			if (key.getCode() == KeyCode.W) { // NORTH
				...
				if (this.roomAt(this.currentRoomPoint).playerPoint.y == 0) {
					this.moveRoom_Direction(Orientation.NORTH, gc);
				} else {
					...
					this.roomAt(this.currentRoomPoint).entityAt(newPlayerPoint).setOrientation(Orientation.NORTH);
					this.roomAt(this.currentRoomPoint).entityAt(newPlayerPoint).updateImage();
				...
				if (this.roomAt(this.currentRoomPoint).playerPoint.x == 0) {
					this.moveRoom_Direction(Orientation.EAST, gc);
				} else {
					...
					// Set the player direction
					newPlayerPoint = this.roomAt(this.currentRoomPoint).playerPoint;
					this.roomAt(this.currentRoomPoint).entityAt(newPlayerPoint).setOrientation(Orientation.EAST);
					this.roomAt(this.currentRoomPoint).entityAt(newPlayerPoint).updateImage();
				...
				if (this.roomAt(this.currentRoomPoint).playerPoint.y == this.roomSize + 1) {
					this.moveRoom_Direction(Orientation.SOUTH, gc);
				} else {
					...
					// Set the player direction
					newPlayerPoint = this.roomAt(this.currentRoomPoint).playerPoint;
					this.roomAt(this.currentRoomPoint).entityAt(newPlayerPoint).setOrientation(Orientation.SOUTH);
					this.roomAt(this.currentRoomPoint).entityAt(newPlayerPoint).updateImage();
				...
				if (this.roomAt(this.currentRoomPoint).playerPoint.x == this.roomSize + 1) {
					this.moveRoom_Direction(Orientation.WEST, gc);
				} else {
					...
					// Set the player direction
					newPlayerPoint = this.roomAt(this.currentRoomPoint).playerPoint;
					this.roomAt(this.currentRoomPoint).entityAt(newPlayerPoint).setOrientation(Orientation.WEST);
					this.roomAt(this.currentRoomPoint).entityAt(newPlayerPoint).updateImage();
